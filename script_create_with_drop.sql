...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tb_user_role` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tb_project` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tb_project_audio` ;
...
CREATE TABLE IF NOT EXISTS `mydb`.`tb_project_audio` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `name_UNIQUE` (`project_id` ASC),
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tb_audio_stream` ;

CREATE TABLE IF NOT EXISTS `mydb`.`tb_audio_stream` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `audio_id` BIGINT NOT NULL,
  `audio_stream` BLOB NULL,
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tb_audio_role` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tb_user_audio` ;
